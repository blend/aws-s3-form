(function() {
  var AwsS3Form, _, cryptoAdapter, mime, utils, uuid,
    ...
    AwsS3Form.prototype.policy = function(filename, options, _predef) {
        ...
        conditions: [
          {
            ...
            "x-amz-server-side-encryption-aws-kms-key-id": this.config.sseKmsKeyId
          }
        ]
      };
      ...
      if (options.customConditions != null) {
        ...
        for (i = 0, len = ref.length; i < len; i++) {
          ...
          if ((_.isArray(ccond) && _.isString(ccond[1]) && ccond[1].toLowerCase() === "$content-type") || (_.isObject(ccond) && (ccond["content-type"] != null))) {
